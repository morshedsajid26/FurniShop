...
const Banner = () => {
  return ( 
    <div >
        ...
        <div className=" bg-[url('/banner.png')] bg-cover bg-no-repeat bg-right md:bg-center pt-[224px] pb-[254px] w-[390px] md:w-full h-[749px] md:h-full  ">
           
        <Container className=' '>
        <div className="title w-[337px] md:w-full text-center flex items-center justify-center flex-col  ">
